...
export class BwRenewAccountParser extends BwParser<RenewAccountTx> {
  public graphicalRepresentation(tx: ProcessedTx<RenewAccountTx>): React.ReactElement {
    return <TransactionRow key={tx.id} tx={tx} />;
  }

  public headerRepresentation(tx: ProcessedTx<RenewAccountTx>, lastOne: boolean): React.ReactElement {
