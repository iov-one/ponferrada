...
export class BwSendParser extends BwParser<ProcessedSendTransaction> {
  ...
  public graphicalRepresentation(sendTx: ProcessedSendTransaction, addresses: Address[]): JSX.Element {
    return <SendTransactionRow key={sendTx.id} sendTx={sendTx} addresses={addresses} />;
  }
